...
export const NOTIFICATION_MESSAGES = {
  ...
  NO_RECIPIENTS_GLOBAL: 'Não há usuários destinatários para notificação global.',
  ...
  UNAUTHORIZED_WARNING_CALL: 'Apenas ADMIN podem criar notificações do tipo WARNING',
