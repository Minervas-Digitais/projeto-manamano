...
describe("GlobalNotification", () => {
    ...
    it("Deve renderizar a tela corretamente", () => {
      const { getByText, getByLabelText } = render(<GlobalNotificationPage navigation={{ goBack: mockGoBack }} />);
    ...
    it("deve mostrar uma mensagem de erro se o campo estiver vazio ao submeter", async () => {
      const { getByText, findByText } = render(<GlobalNotificationPage navigation={{ goBack: mockGoBack }} />);
