                        ...
                        {data.users.map((person) => {
                            ...
                            return (
                                <Card key={person.id} style={{ marginBottom: 10 }} testID={`user-card-${person.id}`}>
                                    ...
                                    {admin && (
                                        <TouchableOpacity  testID={`user-delete-button-${person.id}`} onPress={() => onPressUser(person.id)}>
                                            <TrashCan />
                                        </TouchableOpacity>
                                    )}
                                </Card>
                    ...
                    <Section>
                        ...
                        {data.groups.map((group) => (
                            <Card key={group.id} style={{ marginBottom: 10 }} testID={`group-card-${group.id}`}>
                                ...
                                {admin && (
                                    <TouchableOpacity testID={`group-delete-button-${group.id}`} onPress={() => onPressGroup(group.id)}>
                                        <TrashCan />
                                    </TouchableOpacity>
                                )}
                            </Card>
